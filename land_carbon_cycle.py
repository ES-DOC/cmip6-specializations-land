...
DETAILS['toplevel'] = {
    ...
    'properties': [
        ...
        ('time_step', 'int', '0.1',
             'Time step of carbon cycle in seconds. Specify if there is a single time step for the whole scheme.'),
        ('time_step_photosynthesis_respiration_turn_over', 'int', '0.1',
             'Time step of photosynthesis, respiration and turn over in seconds'),
        ('time_step_carbon_allocated_to_plant_organs', 'int', '0.1',
             'Time step of carbon allocated to plant organs in seconds'),
